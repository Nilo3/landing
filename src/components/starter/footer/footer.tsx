...
export default component$(() => {
  ...
  <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        ...
        <p class="mt-20 mb-10 text-md leading-6 text-black">Un proyecto de la <span class="font-bold">Fundación Argentina de Inteligencia Artificial</span></p>
        <p class="text-sm leading-6 text-black">Zabaleta 27 1ro B </p>
