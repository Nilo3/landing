          ...
          <div class="container mx-auto">
            ...
            <div class="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
              ...
              <div class="mt-10 lg:mt-0 lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center lg:justify-start">
                <a href="https://tally.so/r/mBdlK5" target='_blank' class="rounded-full bg-transparent mt-5 px-5 py-3 text-md font-semibold text-white shadow-sm ring-2 ring-inset ring-white hover:bg-white hover:text-black">Ser Parte</a>
              </div>
            </div>
          </div>
        </div>
