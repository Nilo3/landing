    ...
    <>
      ...
      */}
      ...
      <div class="bg-black py-16 sm:py-24 md:py-32 lg:py-40 xl:py-48">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-2xl lg:mx-0">
            <h2 class="text-3xl sm:text-4xl font-bold tracking-tight text-white sm:text-6xl">¿Cómo puede SAIA ayudarme?</h2>
            <p class="mt-4 sm:mt-6 text-base sm:text-lg leading-6 text-white">SAIA puede ayudarte brindando recursos, conocimientos y oportunidades en el ámbito de la inteligencia artificial. Organizamos eventos, conferencias y talleres donde puedes aprender sobre las últimas tendencias y prácticas en IA. Además, ofrecemos una plataforma de networking donde puedes conectarte con profesionales y expertos en el campo.</p>
          </div>
        </div>
      </div>
