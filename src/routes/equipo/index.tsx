...
export default component$(() => {
  return (
    <>
      ...
      <h4 class='text-white text-4xl justify-center flex mt-12'>Equipo</h4>
        ...
        <div class="grid grid-cols md:grid-cols-2 lg:grid-cols-3 gap-4 mt-12">
          {teamData.equipo.map((member, index) => (
            <div key={index} class="text-center">
              <img src={member.foto} alt={member.nombre} class="w-48 h-48 mx-auto rounded-full mt-4 md:mt-12" width={0} height={0} />
              <p class="text-2xl font-extrabold md:mt-2 text-white">{member.nombre}</p>
